      ...
      <div class="center fl">
        ...
        <div class="botSearch">
          <el-form :inline="true" :model="xcparam" class="demo-form-inline">
            ...
            <el-form-item label>
              <el-button type="primary" @click="search" style="margin:0 30px" v-preventReClick="3000">搜索</el-button>
...
export default {
  ...
  methods: {
    ...
    changeData() {
      this.$emit("changeData", "/home/chiefPer");
    },
    async getHgTop10() {
      let self = this;
...
#chiefPer .botSearch .el-input__inner {
  background-color: #0c1f7f;
  height: 30px;
  line-height: 30px;
...
#chiefPer .botSearch .el-input {
  height: 30px;
  line-height: 30px;
}
#chiefPer .botSearch .el-input__icon {
  line-height: 25px;
}
