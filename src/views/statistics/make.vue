  ...
  <div id="make">
    ...
    <div class="content clearfix">
      ...
      >
        ...
        <el-table-column prop="caseCount" label="总案件量" width></el-table-column>
        <el-table-column prop="uploadCaseCount" label="上传案件数量"></el-table-column>
        <el-table-column prop="passCaseCount" label="合格数量"></el-table-column>
      </el-table>
      <div class="line"></div>
      <div class="chart">
        <div
  ...
  methods: {
    ...
    exportExcel() {
      require.ensure([], () => {
        ...
        let tHeader = ["所属", "总案件量", "上传案件数量", "合格数量"]; // 上面设置Excel的表格第一行的标题
        let name = "";
        if (this.params.queryFlag === "") {
          name = "areaName";
        }
        ...
        let filterVal = [name, "caseCount", "uploadCaseCount", "passCaseCount"]; // 上面是tableData里对象的属性
    ...
    changeData() {
      this.$emit("changeData", "/statistics/make");
    },
    selStart() {
