  ...
  methods: {
    ...
    exportExcel() {
      require.ensure([], () => {
        ...
        let tHeader = ["所属", "上传案件数量", "合格数量", "合格率"]; // 上面设置Excel的表格第一行的标题
        let name = "";
        if (this.params.queryFlag === "") {
          name = "areaName";
        }
        ...
        let filterVal = [name, "uploadCaseCount", "passCaseCount", "passRate"]; // 上面是tableData里对象的属性
    ...
    changeData() {
      this.$emit("changeData", "/statistics/passrote");
    },
    selStart() {
        ...
        for (let index = 0; index < this.tableData.length; index++) {
          ...
          if (this.params.queryFlag === "") {
            this.chartDatas[index] = {
              ...
              合格率: parseFloat(element.passRate)
            };
