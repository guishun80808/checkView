  ...
  <div id="passrank">
    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column prop="passCaseCount" label="电子卷宗合格数量"></el-table-column>
      </el-table>
      <div class="chart">
        <div
          id="chart"
  ...
  methods: {
    ...
    exportExcel() {
      require.ensure([], () => {
        ...
        let tHeader = ["所属", "电子卷宗合格数量"]; // 上面设置Excel的表格第一行的标题
        let name = "";
        if (this.params.queryFlag === "") {
          name = "areaName";
        }
        ...
        let filterVal = [name, "passCaseCount"]; // 上面是tableData里对象的属性
    ...
    changeData() {
      this.$emit("changeData", "/statistics/passrank");
    },
    selStart() {
