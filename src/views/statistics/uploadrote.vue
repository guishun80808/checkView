  ...
  <div id="uploadrote">
    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column prop="unUploadCaseCount" label="未上传案件数量"></el-table-column>
        <el-table-column prop="uploadRate" label="制作率"></el-table-column>
      </el-table>
      <div class="chart">
        <div
          id="chart"
...
export default {
  ...
  methods: {
    ...
    changeData() {
      this.$emit("changeData", "/statistics/uploadrote");
    },
    selStart() {
        ...
        for (let index = 0; index < this.tableData.length; index++) {
          ...
          if (this.params.queryFlag === "") {
            this.chartDatas[index] = {
              ...
              制作率: parseFloat(element.uploadRate)
            };
