  ...
  <div id="query">
    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column prop="uploadIndex" label="随案生成批次"></el-table-column>
        <el-table-column prop="totalFileNum" label="扫描上传页数"></el-table-column>
      </el-table>
      <div class="chart">
        <div
          id="chart"
...
export default {
  ...
  methods: {
    ...
    changeData() {
      this.$emit("changeData", "/statistics/query");
    },
    selStart() {
